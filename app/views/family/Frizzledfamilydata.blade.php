	...
	<div class="col-md-9">
		...
		<div class="col-md-3 pull-right">
            <div class="alert alert-defsult fade in" style="width:300px; padding: 8px 0; margin-bottom: 10px; background-color: #f5f5f5; ">                     
                ...
                <strong>&nbsp;&nbsp;Number of Families:</strong>&nbsp;&nbsp;<div class="pull-right"><span class="label label-default">11</span>&nbsp;&nbsp;&nbsp;</div><br>
                <strong>&nbsp;&nbsp;Number of Family Members:</strong>&nbsp;&nbsp;<div class="pull-right"><span class="label label-default">40</span>&nbsp;&nbsp;&nbsp;</div><br>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			oTable = $('#blogs').dataTable( {
				...
				"bProcessing": true,
				"bServerSide": true,
				"sAjaxSource": "{{ URL::to('Frizzledfamily/Frizzleddata') }}",
