...
@section('content')
	...
	<div class="jumbotron " >
		 ...
		 <div class= "col-sm-6 col-md-3">
		 	<div class="panel panel-primary">
				 ...
				 <h4 class="panel-title text-center">Synteny</h4>
				 </div>
		...
		<div class= "col-sm-6 col-md-3">
			<div class="panel panel-primary">
				<div class="panel-heading">
				 <h4 class="panel-title text-center ">Co-duplicated groups</h4>
				 </div>
   			<div class="panel-body">
	...
	<div class= "col-sm-6 col-md-3">
		<div class="panel panel-primary">
			<div class="panel-heading">
				 <h4 class="panel-title text-center">Time Period</h4>
				 </div>
   			<div class="panel-body">
	...
	<div class= "col-sm-6 col-md-3">
		<div class="panel panel-primary">
			<div class="panel-heading">
				 <h4 class="panel-title text-center">Phylogenetic Trees</h4>
				 </div>
   			<div class="panel-body">
			   
		 	    <p class="text-justify"> The phylogenetic comparission was carried out using the N.J & ML trees.</p>
